    ...
    <header class="pc-header">
        <div class="m-header">
            <a href="index.html" class="b-brand">
                ...
                <img src="<?php echo e(asset('admin')); ?>/images/logo-dark.svg" alt="" class="logo logo-lg" />
            </a>
            <!-- ======= Menu collapse Icon ===== -->
            <div class="pc-h-item">
                ...
                <ul class="list-unstyled">
                            ...
                            <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
                                ...
                                <div class="list-group list-group-flush w-100">
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('admin')); ?>/images/user/avatar-2.jpg"
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('admin')); ?>/images/user/avatar-1.jpg"
                                                    alt="user-image" class="user-avtar" />
                                            </div>
                                            <div class="flex-grow-1 ms-1">
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('admin')); ?>/images/user/avatar-3.jpg"
                                                    alt="user-image" class="user-avtar" />
                                            </div>
                                            <div class="flex-grow-1 ms-1">
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0"
                            data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                            aria-expanded="false">
                            <img src="<?php echo e(asset('admin')); ?>/images/user/avatar-2.jpg" alt="user-image"
                                class="user-avtar" />
                            <span>
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"><i
                                    class="ti ti-key"></i></span><span class="pc-mtext">Authentication</span><span
                                class="pc-arrow"><i class="ti ti-chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" target="_blank"
                                    href="../pages/login-v3.html">Login</a></li>
                            <li class="pc-item"><a class="pc-link" target="_blank"
                    ...
                    <li class="pc-item"><a href="../other/sample-page.html" class="pc-link"><span
                                class="pc-micon"><i class="ti ti-brand-chrome"></i></span><span
...
<?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/pasien/dashboard.blade.php ENDPATH**/ ?>