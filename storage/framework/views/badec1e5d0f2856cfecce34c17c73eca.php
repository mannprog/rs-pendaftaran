<?php $__env->startSection('content'); ?>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h3 class="me-3">Kelola Tindakan</h3>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a></li>
                        <li class="breadcrumb-item" aria-current="page">Kelola Tindakan</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make('admin.pages.tindakan.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("<?php echo e(route('tindakan.index')); ?>" + '/' + data_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('tindakan.index')); ?>" + '/' + data_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola Tindakan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/admin/pages/tindakan/index.blade.php ENDPATH**/ ?>