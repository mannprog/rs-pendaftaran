...
<body>
    ...
    <!-- [ Pre-loader ] End -->
    <!-- [ Header Topbar ] start -->
    <?php echo $__env->make('pasien.layouts.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- [ Header ] end -->
    <!-- [ Sidebar Menu ] start -->
    <?php echo $__env->make('pasien.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- [ Sidebar Menu ] end -->
...
<?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/pasien/layouts/app.blade.php ENDPATH**/ ?>