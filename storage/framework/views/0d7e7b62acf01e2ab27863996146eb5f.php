            ...
            <div class="row">
                <div class="col-lg-20 mt-20" data-aos="zoom-in" data-aos-delay="300">
                    <div class=text-center>
                        <div class="pic"> <img src="<?php echo e(asset('homepage')); ?>/img/jadwal/polianak.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('homepage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/homepage/pages/poli-anak.blade.php ENDPATH**/ ?>