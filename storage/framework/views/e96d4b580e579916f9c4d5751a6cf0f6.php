<header class="pc-header">
    <div class="m-header">
        <a href="<?php echo e(route('pasien.dashboard')); ?>" class="b-brand mx-auto">
...
<?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/pasien/layouts/topbar.blade.php ENDPATH**/ ?>