<form id="deleteDoc" method="post">
    ...
    <a href="<?php echo e(route('pendaftaran.show', $row->id)); ?>" class="btn btn-sm mb-0 btn-info"><i class="ti ti-eye"></i></a>
...
<?php /**PATH C:\laragon\www\rs-pendaftaran\resources\views/admin/pages/pendaftaran/component/action.blade.php ENDPATH**/ ?>