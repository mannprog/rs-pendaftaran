@extends('admin.layouts.app', ['title' => 'Kelola Tindakan'])
...
@section('content')
    ...
    @include('admin.pages.tindakan.component.addOrEdit')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("{{ route('tindakan.index') }}" + '/' + data_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('tindakan.index') }}" + '/' + data_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
