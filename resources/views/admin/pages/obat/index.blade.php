@extends('admin.layouts.app', ['title' => 'Kelola Obat'])
...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h3 class="me-3">Kelola Obat</h3>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item" aria-current="page">Kelola Obat</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    @include('admin.pages.obat.component.addOrEdit')
@endsection
