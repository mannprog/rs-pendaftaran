@extends('admin.layouts.app', ['title' => 'Kelola Dokter'])
...
@section('content')
    ...
    @include('admin.pages.dokter.component.addOrEdit')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("{{ route('dokter.index') }}" + '/' + data_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('dokter.index') }}" + '/' + data_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
