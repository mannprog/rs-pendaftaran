@extends('pasien.layouts.app', ['title' => 'Kelola Pendaftaran'])
...
@section('content')
    ...
    @include('pasien.pages.pendaftaran.component.addOrEdit')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('pasien.pendaftaran.store') }}",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("{{ route('pasien.pendaftaran.index') }}" + '/' + data_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('pasien.pendaftaran.index') }}" + '/' + data_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
