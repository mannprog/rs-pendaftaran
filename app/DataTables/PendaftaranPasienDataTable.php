...
class PendaftaranPasienDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('pasien.pages.pendaftaran.component.action', compact('row'))->render();
        })
        ->rawColumns(['action']);
    }
    ...
    {
        return $this->builder()
                    ->setTableId('pendaftaranpasien-table')
    ...
    {
        return 'PendaftaranPasien_' . date('YmdHis');
    }
}
